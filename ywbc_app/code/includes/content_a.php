...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row row_2 row_today clearfix col-xs-12">
			<div class="col-xs-4 col-xs-offset-2">
				<h3>Today's UV</h3>
			</div>	
				
			<div class="col-xs-4" id="today">
		...
		<div class="row row_exposure_time row_3 clearfix col-xs-12">
		
			<div class="exp_pic exp col-xs-4">
				<img src="images/clock_white.png" alt="pic" title="picture of clock" class="img-responsive">
			</div>
			<div class="exp_time exp col-xs-4" id="expTime">
				<h4><!--js injects value here--></h4>
			</div>
			<div class="exp_mess exp col-xs-4" id="expUnit">
				<h3>mins<br>MAX</h3>
			</div>	

		</div>

		<div class="row row_nextday row_3 clearfix col-xs-12">
		
			<div class="col-xs-4 col-xs-offset-2" id="nextday">
				<h3>Outlook</h3>
			</div>	

			<div class="row_nextday_rating col-xs-4" id="outlook">
				<h2><!--js injects value here--></h2>
			</div>	
